...
export default function Highlights(){
    return(
        ...
        <div className="highlights mt-4">
            <h2 className="text-center">Our<StyleSpan color="#810000">Highlights</StyleSpan> </h2>
            <div className="highlight-content " data-aos="zoom-out">
                <Container>
                <h4>THE HIGHLIGHTS OF ACTIVITIES AT THE INDIAN</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
                                ...
                                atque quidem! Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
                                perferendis molestiae non nemo doloribus. Doloremque, nihil! At ea
                                atque quidem!Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
                                perferendis molestiae non nemo doloribus. Doloremque, nihil! At ea
                                atque quidem!</p>
                ...
                <Row>
                    ...
                    <div class="card">
                        ...
                        <div class="card__body">
                            ...
                            <h4 className="text-center">ICSK SHOWS THE WAY WITH HAIYAN RELIEF</h4>
                            <p>
...
<img src="https://www.greatschools.org/gk/wp-content/uploads/2014/03/The-school-visit-what-to-look-for-what-to-ask-1.jpg"/>
            ...
            <div className="section-div bgRed mt-4">
                <h5 className="text-center p-2"><StyleSpan color="#fff">AN EDUCATION WITH VALUES & CULTURAL FIESTAS</StyleSpan></h5>
                <Container fluid>
                <Row>
            ...
            <div className="highlight-content" data-aos="fade-up">
                <Container>
                <h4><StyleSpan color="#810000">CHARITY</StyleSpan></h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
                                perferendis molestiae non nemo doloribus. Doloremque, nihil! At ea
                                atque quidem! Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
                                perferendis molestiae non nemo doloribus. Doloremque, nihil! At ea
